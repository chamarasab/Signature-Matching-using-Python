...
def capture_image_from_cam_into_temp(sign=1):
    ...
    while True:
        ...
        if k % 256 == 27:
            ...
            if(sign == 1):
                img_name = "https://github.com/RamchennaB/Signature-Matching-using-Python/signatures/IMG_2276.jpeg"
            else:
                img_name = "https://github.com/RamchennaB/Signature-Matching-using-Python/signatures/IMG_2277.jpeg"
